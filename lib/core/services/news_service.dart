  ...
  List<NewsItem> _getOfflineMockNews(String category) {
    return [
      NewsItem(
        ...
        url: 'https://deeptruth.app/education/deepfakes',
        source: 'DeepTruth Trust Observatory',
        publishedAt: DateTime.now().subtract(const Duration(hours: 2)),
        category: category,
        aiSummary: 'DeepTruth Observatory highlights a rise in deepfakes. Users are advised to rely on verified metadata, trace sources, and avoid instant re-shares of emotionally charged clips.',
        truthScore: 85,
      ),
      NewsItem(
        id: 'mock_2',
        ...
        url: 'https://deeptruth.app/education/scams',
